  ...
  afterAuth(auth, req, evt) {
    ...
    if (process.env.NODE_ENV === 'production') {
      response.headers.set(
        ...
        "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.clerk.io https://js.clerk.io; connect-src 'self' https://api.clerk.io https://api.openai.com https://*.vercel-storage.com; img-src 'self' data: https://*.clerk.com https://*.public.blob.vercel-storage.com; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-src 'self' https://accounts.clerk.com;"
      );
    }
